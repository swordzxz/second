...
def test(points,
    ...
    # print("points_shape", point_shape)
    example_shape = example["coordinates"].shape[0]
    a= np.zeros([example_shape,1],int)
    print("a.shape", a.shape)
    print("example_coor.shape", example["coordinates"].shape)
    ...
    print("anchor_shape", example["anchors"].shape)
    example["anchors"]=example["anchors"].reshape([1,168960,7])
    example["image_idx"] = np.array([1])
...
#     test(points=points,
#          config_path="/root/second-1.5/second/configs/car.fhd.config",
