...
# -*- coding: utf-8 -*-
import sys
sys.path.append("/home/zxz/secong/second")
...
from pytorch.train_3 import test
...
def velo_callback(msg):
    ...
    results = test(np_p_ranged, config_path="/home/ubuntu/second-1.5/second/configs/car.fhd.config",
                       model_dir="/home/zxz/second/model",
